...
class TestePessoa(unittest.TestCase):
    ...
    # Configurando para sempre instanciar a classe na execução de todos os métodos de teste
    def setUp(self):
        self.p1 = Pessoa('Rafael', 'Ribeiro')
        self.p2 = Pessoa('Pedro', 'Oliveira')

    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Rafael')
        self.assertEqual(self.p2.nome, 'Pedro')

    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Ribeiro')
    ...
    def test_pessoa_attr_dados_obtidos_e_bool(self):
        ...
        self.assertIsInstance(self.p2.dados_obtidos, bool)
